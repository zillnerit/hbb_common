...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("Zillner IT Remote".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["rustdesk.zillner.it"];
pub const RS_PUB_KEY: &str = "DNwrICKPC4Rcopj1IECiTUWkuHRf6EurzSlIm1WiTp0=";
